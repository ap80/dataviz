...
str(iris) # informasi tentang struktur sebuah object
colnames(iris) # retrive set  nama baris atau nama kolom  pada objet bernetuk matirx
head(iris) #mengembaikan nilai pertama atau terakhir dari data frame atau dari fungsi
tail(iris) #mengembaikan nilai pertama atau terakhir dari data frame atau dari fungsi
summary(iris) # menghasilkan nilai ringkasan suatu model
